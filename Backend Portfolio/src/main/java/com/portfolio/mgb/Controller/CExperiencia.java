...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){      
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreExperiencia(), dtoexp.getNombreEmpresa(),dtoexp.getTipoExperiencia());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        ...
        if(sExperiencia.existsByNombreExperiencia(dtoexp.getNombreExperiencia()) && sExperiencia.getByNombreExperiencia(dtoexp.getNombreExperiencia()).get().getId() != id)
        ...
        experiencia.setTipoExperiencia(dtoexp.getTipoExperiencia());
